          ...
          <div class="register-form">
            <form method="POST" action="{{ route('register') }}" name="register-form" class="needs-validation" novalidate="">
              ...
              <div class="d-flex align-items-center mb-3 pb-2">
                <p class="m-0">Seus dados pessoais serão usados para melhorar sua 
                  experiência ao longo deste site, gerenciar o acesso à sua conta e 
                  para outros fins descritos em nossa política de privacidade.</p>
              </div>
              ...
              <div class="customer-option mt-4 text-center">
                ...
                <a href="{{ route('login')}}" class="btn-text js-show-register">Acesse sua conta</a>
              </div>
            </form>
          </div>
        </div>
